            ...
            <div class="nano-content">
                <ul>
                    <div class="logo"><a href="index.html">
                            <!-- <img src="assets/images/logo.png" alt="" /> --><span>BJW</span></a></div>
                    <li class="label">Main</li>
                    <li><a href="{{ route('admin.home') }}"><i class="ti-home"></i> Features</a>
                    </li>
                    <li><a href="{{ route('admin.newsanchor.index') }}"><i class="ti-desktop"></i> News Anchor</a>
                    </li>
                    <li><a href="{{ route('admin.videos.index') }}"><i class="ti-camera"></i> Videos</a>
                    </li>
