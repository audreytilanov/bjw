    ...
    <section id="about">
        ...
        <div id="content">
            ...
            <div class="desc">
                ...
                <form action="{{ route('user.video.submit') }}" method="post" enctype="multipart/form-data" enctype="multipart/form-data">
                    @csrf
        ...
        <div class="contentPengumpulan">
            ...
            <form action="{{ route('user.video.pengumpulan') }}" method="post" enctype="multipart/form-data" enctype="multipart/form-data">
                @csrf
                <label for="email">Email*</label>
                <input type="text" name="email" id="email" placeholder="Email" value="{{ old('email') }}" required><br>
                @error('email')
                ...
                <input type="text" name="link" id="link" placeholder="Link Google Drive" value="{{ old('link') }}" required><br>
                @error('link')
                    <span class="text-danger" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
