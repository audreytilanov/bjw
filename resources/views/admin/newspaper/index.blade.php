                ...
                <div class="col-lg-8 p-r-0 title-margin-right">
                    <div class="page-header">
                        <div class="page-title">
                            <h1><b>Mini News Paper</b>, <span>Master Data</span></h1>
                        </div>
                    </div>
                </div>
                <!-- /# column -->
                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Mini News Paper</li>
                            </ol>
                        </div>
                    </div>
                                    ...
                                    <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ URL::asset('mininews_asset/proof_of_payment/'.$datas->proof_of_payment) }}" alt="" width="100px">
                                                    <form action="{{ route('admin.newspaper.pop', $datas->id) }}" method="POST">
                                                        @csrf
                                                        <input class="btn btn-primary" type="submit" name="submit" value="Download" id="submit">
                                                    </form>
                                                </td>
                                                <td>
                                                    <img src="{{ URL::asset('mininews_asset/ktm/'.$datas->ktm) }}" alt="" width="100px">
                                                    <form action="{{ route('admin.newspaper.ktm', $datas->id) }}" method="POST">
                                                        @csrf
                                                        <input class="btn btn-primary" type="submit" name="submit" value="Download" id="submit">
                                                    </form>
                                                </td>
                                                ...
                                                <td>
                                                    @if($datas->status == "pending")
                                                        <form style="display: inline" action="{{ route('admin.newspaper.accept', $datas->id) }}" id="delete-form-verify{{ $datas->id }}" method="POST">
                                                            @csrf
                                                            <button value="{{ $datas->id }}" id="btn-submit-verify"  class="btn btn-success btn-flat btn-addon" type="submit">Accept</button>
                                                        </form>
                                                        <br>
                                                        <br>
                                                        <form style="display: inline" action="{{ route('admin.newspaper.decline', $datas->id) }}" id="delete-form-notverify{{ $datas->id }}" method="POST">
                                                            @csrf
                                                    ...
                                                    @else
                                                        <form style="display: inline" action="{{ route('admin.newspaper.delete', ['id' => $datas->id]) }}" method="post" id="delete-form{{ $datas->id }}">
                                                            @csrf
