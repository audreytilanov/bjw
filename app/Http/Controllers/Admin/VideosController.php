...
class VideosController extends Controller
{
    ...
    public function accept($id){
        ...
        $message = 'Terimakasih telah ikut berpartisipasi dalam perlombaan video Bali Journalist Week 2022. Anda telah terdaftar, dan berikut merupakan kode pengumpulan anda. Dimohon untuk tidak menyebarkan kode unik ini. Pengumpulan dilakukan pada tanggal yang telah ditentukan.';
